...
def start_training_pipeline():
    try:
        ...
        # Model trainer
        model_trainer_confg=config_entity.ModelTrainerConfig(training_pipeline_config=training_pipeline_config)
        model_trainer=ModelTrainer(model_trainer_config=model_trainer_confg,data_transformation_artifact=data_transformation_artifact)
